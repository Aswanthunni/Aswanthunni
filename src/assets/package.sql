...
CREATE TABLE IF NOT EXISTS restore(id INTEGER PRIMARY KEY AUTOINCREMENT,lastdate TEXT);

CREATE TABLE IF NOT EXISTS admission(id INTEGER PRIMARY KEY AUTOINCREMENT,fees TEXT);

CREATE TABLE IF NOT EXISTS uniqueid(id INTEGER PRIMARY KEY AUTOINCREMENT,uid TEXT);
